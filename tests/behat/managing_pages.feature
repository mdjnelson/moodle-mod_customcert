@mod @mod_customcert
Feature: Being able to manage pages on a certificate
  In order to test managing pages in a certificate works as expected
  As a teacher
  ...
  Scenario: Adding a page to a certificate
    And I follow "Add page"
    And I should see "Page 1"
    And I should see "Page 2"

  Scenario: Deleting a page from a certificate
