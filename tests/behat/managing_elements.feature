@mod @mod_customcert
Feature: Being able to manage elements on a certificate
  In order to test managing elements in a certificate works as expected
  As a teacher
  I need to manage elements in a certificate
  ...
  Scenario: Add and edit elements in a certificate
    # Background image.
  ...
  Scenario: Delete an element from a certificate
    And I add the element "Background image" to page "1" of the "Custom certificate 1" certificate template
    And I press "Save changes"
    And I should see "Background image" in the "elementstable" "table"
    And I add the element "Student name" to page "1" of the "Custom certificate 1" certificate template
