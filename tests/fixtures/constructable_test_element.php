...
/**
 * Test fixture: constructable element used to verify factory preference.
 *
 ...
 */
class constructable_test_element extends \mod_customcert\element implements constructable_element_interface, element_interface {
    /**
     * Flag to indicate from_record path was taken.
     * @var bool
     */
    public static bool $called = false;

    /**
     * Build from record and mark the flag for assertion.
     *
     * @param \stdClass $record Raw DB row
     * @return static
     */
    public static function from_record(\stdClass $record): static {
        self::$called = true;
        $record = clone $record;
        $record->data = json_encode(['constructedby' => 'from_record']);
