...
function xmldb_customcert_upgrade($oldversion) {
    ...
    if ($oldversion < 2016120505) {
        ...
        $field = new xmldb_field('emailteachers', XMLDB_TYPE_INTEGER, '1', null, XMLDB_NOTNULL, null, '0', 'requiredtime');
        ...
        $field = new xmldb_field('emailothers', XMLDB_TYPE_TEXT, null, null, null, null, null);
