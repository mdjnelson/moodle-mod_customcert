...
class generate_site_certificates_download_task extends adhoc_task {
    ...
    public function execute(): void {
        ...
        $zip = $this->create_download_service()->generate_all_for_site_zip();
        if ($zip === null) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($context->id, 'mod_customcert', certificate_download_service::SITE_DOWNLOAD_FILEAREA, $userid);
    ...
    /**
     * Create the certificate download service used by this task.
     *
    ...
    protected function create_download_service(): certificate_download_service {
        return certificate_download_service::create();
    }
