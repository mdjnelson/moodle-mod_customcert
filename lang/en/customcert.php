...
$string['importerror_absolutepath'] = 'Archive contains an absolute path: {$a}';
$string['importerror_filetoolarge'] = 'A file in the archive exceeds the size limit: {$a}';
$string['importerror_invalidjson'] = 'Invalid template.json (not valid JSON)';
$string['importerror_missingname'] = 'Template is missing the required name attribute';
$string['importerror_pathtoomanyfiles'] = 'Too many files in archive (max {$a})';
$string['importerror_pathtraversal'] = 'Archive contains a path traversal entry: {$a}';
$string['importerror_totalsizelimit'] = 'Archive total uncompressed size exceeds the allowed limit';
$string['importerror_unsafefilename'] = 'Archive contains an unsafe filename: {$a}';
