...
$string['type'] = 'Type';
$string['uploadimage'] = 'Charger image';
$string['uploadimagedesc'] = 'Ce lien vous amènera à un nouvel écran où vous pourrez télécharger des images. Les images téléchargées suivant cette méthode seront disponibles sur tout le site pour tous les utilisateurs habilités à créer un certificat personnalisé.';
$string['viewcustomcertissues'] = 'Voir {$a} certificat(s) décerné(s)';
