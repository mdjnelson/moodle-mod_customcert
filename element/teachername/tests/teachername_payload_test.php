...
/**
 * Tests for teachername_payload.
 *
 * @package    customcertelement_teachername
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_teachername\teachername_payload
 */
final class teachername_payload_test extends advanced_testcase {
    /**
     * teachername_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = teachername_payload::from_array([]);
    ...
    public function test_from_array_full_data(): void {
        ...
        $this->assertSame('editingteacher', $payload->teacher);
    ...
    public function test_to_array_returns_expected_keys(): void {
        $payload = teachername_payload::from_array([]);
        $this->assertSame(['teacher', 'font', 'fontsize', 'colour', 'width'], array_keys($payload->to_array()));
    }
    ...
    public function test_round_trip(): void {
        ...
        $payload = teachername_payload::from_array($original);
