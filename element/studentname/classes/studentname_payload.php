...
/**
 * Typed payload for the studentname element.
 *
 ...
 * Typed payload for the studentname element.
 *
 * The studentname element stores only the four standard visual style fields.
 *
 * @package    customcertelement_studentname
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class studentname_payload implements element_payload_interface {
    /**
     * Construct a studentname_payload.
     *
    ...
    /**
     * Construct a studentname_payload from a decoded data array.
     *
