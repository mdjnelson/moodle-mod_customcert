...
/**
 * Tests for studentname_payload.
 *
 * @package    customcertelement_studentname
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_studentname\studentname_payload
 */
final class studentname_payload_test extends advanced_testcase {
    /**
     * studentname_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = studentname_payload::from_array([]);
    ...
    public function test_round_trip(): void {
        ...
        $payload = studentname_payload::from_array($original);
