...
/**
 * Typed payload for the code element.
 *
 ...
 * Typed payload for the code element.
 *
 * The code element stores only the four standard visual style fields.
 *
 * @package    customcertelement_code
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class code_payload implements element_payload_interface {
    /**
     * Construct a code_payload.
     *
    ...
    /**
     * Construct a code_payload from a decoded data array.
     *
