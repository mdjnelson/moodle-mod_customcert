...
/**
 * Tests for code_payload.
 *
 * @package    customcertelement_code
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_code\code_payload
 */
final class code_payload_test extends advanced_testcase {
    /**
     * code_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = code_payload::from_array([]);
    ...
    public function test_round_trip(): void {
        ...
        $payload = code_payload::from_array($original);
