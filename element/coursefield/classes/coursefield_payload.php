...
/**
 * Typed payload for the coursefield element.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class coursefield_payload implements element_payload_interface {
    /**
     * Construct a coursefield_payload.
     *
     * @param string $coursefield The course field identifier to display.
     * @param stylable_payload $style The four standard visual style fields.
     */
    public function __construct(
        /** @var string The course field identifier to display. */
        public readonly string $coursefield,
    ...
    /**
     * Construct a coursefield_payload from a decoded data array.
     *
    ...
    public static function from_array(array $data): static {
        return new static(
            coursefield: (string)($data['coursefield'] ?? ''),
     ...
     *
     * @return array{coursefield:string,font:string,fontsize:int,colour:string,width:int}
     */
    public function to_array(): array {
        return array_merge(
            ['coursefield' => $this->coursefield],
            $this->style->to_array(),
        );
    }
