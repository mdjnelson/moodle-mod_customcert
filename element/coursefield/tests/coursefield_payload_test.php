...
/**
 * Tests for coursefield_payload.
 *
 * @package    customcertelement_coursefield
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_coursefield\coursefield_payload
 */
final class coursefield_payload_test extends advanced_testcase {
    /**
     * coursefield_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = coursefield_payload::from_array([]);
    ...
    public function test_from_array_full_data(): void {
        ...
        $this->assertSame('shortname', $payload->coursefield);
    ...
    public function test_from_array_defaults_on_empty(): void {
        ...
        $this->assertSame('', $payload->coursefield);
    ...
    /**
     * from_array() casts string integers to their canonical types.
     */
    ...
    public function test_to_array_returns_expected_keys(): void {
        $payload = coursefield_payload::from_array([]);
        $this->assertSame(['coursefield', 'font', 'fontsize', 'colour', 'width'], array_keys($payload->to_array()));
    }
    ...
    public function test_round_trip(): void {
        ...
        $payload = coursefield_payload::from_array($original);
