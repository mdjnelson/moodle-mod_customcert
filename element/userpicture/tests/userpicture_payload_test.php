...
/**
 * Tests for userpicture_payload.
 *
 * @package    customcertelement_userpicture
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_userpicture\userpicture_payload
 */
final class userpicture_payload_test extends advanced_testcase {
    /**
     * userpicture_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = userpicture_payload::from_array([]);
    ...
    public function test_from_array_full_data(): void {
        ...
        $this->assertSame(60, $payload->width);
        $this->assertSame(60, $payload->height);
    }
    ...
    public function test_from_array_casts_values(): void {
        $payload = userpicture_payload::from_array(['width' => '40', 'height' => '40']);
    ...
    public function test_round_trip(): void {
        ...
        $payload = userpicture_payload::from_array($original);
