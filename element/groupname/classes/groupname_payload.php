...
/**
 * Typed payload for the groupname element.
 *
 ...
 * Typed payload for the groupname element.
 *
 * The groupname element stores only the four standard visual style fields.
 *
 * @package    customcertelement_groupname
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class groupname_payload implements element_payload_interface {
    /**
     * Construct a groupname_payload.
     *
    ...
    /**
     * Construct a groupname_payload from a decoded data array.
     *
