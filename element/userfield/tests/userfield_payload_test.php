...
/**
 * Tests for userfield_payload.
 *
 * @package    customcertelement_userfield
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_userfield\userfield_payload
 */
final class userfield_payload_test extends advanced_testcase {
    /**
     * userfield_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = userfield_payload::from_array([]);
    ...
    public function test_from_array_full_data(): void {
        ...
        $this->assertSame('email', $payload->userfield);
    ...
    public function test_from_array_defaults_on_empty(): void {
        ...
        $this->assertSame('', $payload->userfield);
    ...
    public function test_to_array_returns_expected_keys(): void {
        $payload = userfield_payload::from_array([]);
        $this->assertSame(['userfield', 'font', 'fontsize', 'colour', 'width'], array_keys($payload->to_array()));
    }
    ...
    public function test_round_trip(): void {
        ...
        $payload = userfield_payload::from_array($original);
