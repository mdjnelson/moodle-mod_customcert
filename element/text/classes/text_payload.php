...
/**
 * Typed payload for the text element.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class text_payload implements element_payload_interface {
    /**
     * Construct a text_payload.
     *
     * @param string $text The static text content.
     * @param stylable_payload $style The four standard visual style fields.
     */
    public function __construct(
        /** @var string The static text content. */
    ...
    /**
     * Construct a text_payload from a decoded data array.
     *
     ...
     *
     * @return array{text:string,font:string,fontsize:int,colour:string,width:int}
     */
