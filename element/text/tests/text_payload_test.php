 ...
 * @covers \customcertelement_text\text_payload
 */
final class text_payload_test extends advanced_testcase {
    /**
     * text_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = text_payload::from_array([]);
    ...
    public function test_to_array_returns_expected_keys(): void {
        $payload = text_payload::from_array([]);
        $this->assertSame(['text', 'font', 'fontsize', 'colour', 'width'], array_keys($payload->to_array()));
    }
    ...
    public function test_round_trip(): void {
        ...
        $payload = text_payload::from_array($original);
