...
/**
 * Typed payload for the expiry element.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class expiry_payload implements element_payload_interface {
    /**
     * Construct an expiry_payload.
     *
     * @param string $dateitem The date item identifier.
     * @param string $dateformat The date format string.
     * @param string $startfrom The start-from value.
    ...
    public function __construct(
        ...
        /** @var string The start-from value. */
    ...
    /**
     * Construct an expiry_payload from a decoded data array.
     *
    ...
    public static function from_array(array $data): static {
        return new static(
            ...
            startfrom: (string)($data['startfrom'] ?? ''),
     ...
     *
     * @return array{dateitem:string,dateformat:string,startfrom:string,font:string,fontsize:int,colour:string,width:int}
     */
