...
/**
 * Tests for expiry_payload.
 *
 * @package    customcertelement_expiry
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_expiry\expiry_payload
 */
final class expiry_payload_test extends advanced_testcase {
    /**
     * expiry_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = expiry_payload::from_array([]);
    ...
    public function test_from_array_full_data(): void {
        ...
        $this->assertSame('enrolment', $payload->startfrom);
    ...
    public function test_from_array_defaults_on_empty(): void {
        ...
        $this->assertSame('', $payload->startfrom);
    ...
    /**
     * to_array() returns exactly the seven expected keys.
     */
    public function test_to_array_returns_expected_keys(): void {
        $payload = expiry_payload::from_array([]);
        $this->assertSame(
            ['dateitem', 'dateformat', 'startfrom', 'font', 'fontsize', 'colour', 'width'],
    ...
    public function test_round_trip(): void {
        ...
        $payload = expiry_payload::from_array($original);
