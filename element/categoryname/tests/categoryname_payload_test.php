...
/**
 * Tests for categoryname_payload.
 *
 * @package    customcertelement_categoryname
 * @category   test
 * @copyright  2026 Mark Nelson <mdjnelson@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \customcertelement_categoryname\categoryname_payload
 */
final class categoryname_payload_test extends advanced_testcase {
    /**
     * categoryname_payload implements element_payload_interface.
     */
    public function test_implements_payload_interface(): void {
        $payload = categoryname_payload::from_array([]);
    ...
    public function test_round_trip(): void {
        ...
        $payload = categoryname_payload::from_array($original);
